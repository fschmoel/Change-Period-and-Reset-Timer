...
public:
	...
	*/
	Keypad(char *userKeymap, byte *row, byte *col, byte rows, byte cols, byte allowRollKeys);
...
/*
|| @changelog
|| | 1.8 2011-04-26 - Marius Liebenberg : Added rolling keys ability when the key is held 
